...
$(document).ready(function() {
    ...
    $(this).prepend(
      ...
      '<button class="toolbtn remove" data-tooltip="true" data-placement="top" title="Download Image" style="left:34px;z-index: 111;position: absolute; background-color: White;border: none;color: Black;padding: 7px 9px;font-size: 16px;cursor: pointer;border-radius: 5%;"><i class="fas fa-download toolbtn"></i></button>'+
