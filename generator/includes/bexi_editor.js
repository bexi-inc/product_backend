 ...
 $(document).ready(function() {
     ...
     $( ".bexi_subtitle" ).wrap( "<div class='bexi_editor_subtitle'  style='width: 100%;'></div>" );
       ...
       $(".bexi_module").prepend($('<div class="bexi_module_bg transpa-bg" style="background-size: cover; position: absolute; top: 0; left: 0; width: inherit;height: inherit; z-index: 0;"></div>'));
