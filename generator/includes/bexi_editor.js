            ...
            '<div id="tabs-img">'+
              ...
              '<div id="tab-1">'+
                '<div id="blah" class="col-lg-12 dropzone" >'+
                  '<label for="inpimg'+num+'" Class="C" ondrop="previewImg('+num+')" ondragover="return false" style="height:100%;width:100%;cursor: pointer;">Drop Your Image Here<Br>(Or Click)</label>'+
