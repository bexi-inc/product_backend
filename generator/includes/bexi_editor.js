 ...
 $(document).ready(function() {
     ...
     $( ".bexi_subtitle" ).wrap( "<div class='bexi_editor_subtitle'  style='width: 100%;'></div>" );
       ...
       var num=1;
       $(".bexi_module").prepend('<div id="'+Math.floor((Math.random() * 100) + 1)+'" class="bexi_module_bg transpa-bg" style="background-size: cover; position: absolute; top: 0; left: 0; width: inherit;height: 100%; z-index: 0;"></div>');
