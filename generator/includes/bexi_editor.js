 ...
 $(document).ready(function() {
     ...
     $( ".bexi_subtitle" ).wrap( "<div class='bexi_editor_subtitle'  style='width: 100%;'></div>" );
       ...
       $('.bexi_module').each(function() {
        ...
        $(this).prepend('<button class="btn" onClick="bgchange(this.id)" id="'+Math.floor((Math.random() * 10000) + 1)+'" style="z-index: 5;position: absolute; top: 0; left: 0;background-color: DodgerBlue;border: none;color: white;padding: 12px 16px;font-size: 16px;cursor: pointer;"><i class="fas fa-fill-drip"></i></button>')
      });
