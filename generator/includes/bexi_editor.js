 function rgb2hex(rgb){
  ...
  $( "#dialog-1" ).dialog({
            ...
            buttons: {
              "Save": function() {
                $($(this).attr("data-id")).closest(".bexi_module").attr('style','position:relative; background-color:'+$("#colorpicker_1").minicolors("rgbString")+'!important;');
                $( this ).dialog( "close" );
              },
              Cancel: function() {
                $( this ).dialog( "close" );
 ...
 $(document).ready(function() {
     ...
     $( ".bexi_subtitle" ).wrap( "<div class='bexi_editor_subtitle'  style='width: 100%;'></div>" );
       ...
       $('.bexi_module').each(function() {
        ...
        $(this).prepend('<button class="btn" onClick="bgchange(this.id)" id="'+Math.floor((Math.random() * 10000) + 1)+'" style="z-index: 5;position: absolute; top: 0; left: 0;background-color: #f8f8f8;border: none;color: Black;padding: 7px 9px;font-size: 16px;cursor: pointer;margin-left:15px;margin-top:15px;"><i class="fas fa-fill-drip"></i></button>')
      });
